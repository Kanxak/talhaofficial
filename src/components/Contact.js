      ...
      <div className='flex flex-col lg:flex-row'>
        ...
        className='flex-1 border border-black rounded-2xl flex flex-col gap-y-6 pb-24 p-6 items-start'>
          ...
          placeholder='Your email'
           />    
           <textarea className='bg-transparent border-b py-12 outline-none w-full placeholder:text-black focus:border-accent transition-all resize-none mb-12' placeholder='Your message'
           ></textarea> 
